...
for i in range(10000):
    ...
    print(
        f'pos_left={x_left:.3f}, {y_left:.3f}, {z_left:.3f}, Rot_left={roll_left:.3f}, {pitch_left:.3f}, {yaw_left:.3f}, gripper_left={gripper_left}, control_button_left={control_button_left}')
