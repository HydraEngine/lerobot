...
from lerobot.robots.xlerobot_2wheels import XLerobot2WheelsClient, XLerobot2WheelsClientConfig, \
    XLerobot2WheelsConfig, XLerobot2Wheels
    ...
    def execute_rectangular_trajectory(self, robot, fps=30):
        ...
        while True:
            ...
            try:
                ...
                print(
                    f"[{self.prefix}] IK failed at x={self.current_x:.4f}, y={self.current_y:.4f}: {e}")
                break
...
def main():
    ...
    try:
        while True:
            ...
            right_key_state = {action: (key in pressed_keys) for action, key in
                               RIGHT_KEYMAP.items()}
